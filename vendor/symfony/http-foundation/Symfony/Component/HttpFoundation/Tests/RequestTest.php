    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                '/foo%20bar',
                array(
                    'SCRIPT_FILENAME' => '/home/John Doe/public_html/foo bar/API.php',
                    'SCRIPT_NAME'     => '/foo bar/API.php',
                    'PHP_SELF'        => '/foo bar/API.php',
                ),
                '/foo%20bar',
                '/',
            ),
            ...
            array(
                '/foo/bar+baz',
                array(
                    'SCRIPT_FILENAME' => '/home/John Doe/public_html/foo/API.php',
                    'SCRIPT_NAME'     => '/foo/API.php',
                    'PHP_SELF'        => '/foo/API.php',
                ),
                '/foo',
                '/bar+baz',
            ),
