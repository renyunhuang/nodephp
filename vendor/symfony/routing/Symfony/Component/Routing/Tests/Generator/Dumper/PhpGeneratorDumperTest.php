...
class PhpGeneratorDumperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDumpWithRoutes()
    {
        ...
        $projectUrlGenerator = new \ProjectUrlGenerator(new RequestContext('/API.php'));
        ...
        $this->assertEquals($absoluteUrlWithParameter, 'http://localhost/API.php/testing/bar');
        $this->assertEquals($absoluteUrlWithoutParameter, 'http://localhost/API.php/testing2');
        $this->assertEquals($relativeUrlWithParameter, '/API.php/testing/bar');
        $this->assertEquals($relativeUrlWithoutParameter, '/API.php/testing2');
    }
    ...
    public function testDumpWithoutRoutes()
    {
        ...
        $projectUrlGenerator = new \WithoutRoutesUrlGenerator(new RequestContext('/API.php'));
