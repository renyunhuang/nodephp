...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    public function testAbsoluteUrlWithPort80()
    {
        ...
        $this->assertEquals('http://localhost/API.php/testing', $url);
    }
    ...
    public function testAbsoluteSecureUrlWithPort443()
    {
        ...
        $this->assertEquals('https://localhost/API.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithNonStandardPort()
    {
        ...
        $this->assertEquals('http://localhost:8080/API.php/testing', $url);
    }
    ...
    public function testAbsoluteSecureUrlWithNonStandardPort()
    {
        ...
        $this->assertEquals('https://localhost:8080/API.php/testing', $url);
    }
    ...
    public function testRelativeUrlWithoutParameters()
    {
        ...
        $this->assertEquals('/API.php/testing', $url);
    }
    ...
    public function testRelativeUrlWithParameter()
    {
        ...
        $this->assertEquals('/API.php/testing/bar', $url);
    }
    ...
    public function testRelativeUrlWithOptionalZeroParameter()
    {
        ...
        $this->assertEquals('/API.php/testing/0', $url);
    }
    ...
    public function testRelativeUrlWithExtraParameters()
    {
        ...
        $this->assertEquals('/API.php/testing?foo=bar', $url);
    }
    ...
    public function testAbsoluteUrlWithExtraParameters()
    {
        ...
        $this->assertEquals('http://localhost/API.php/testing?foo=bar', $url);
    }
    ...
    public function testUrlWithExtraParametersFromGlobals()
    {
        ...
        $context = new RequestContext('/API.php');
    ...
    public function testSchemeRequirementDoesNothingIfSameCurrentScheme()
    {
        ...
        $this->assertEquals('/API.php/', $this->getGenerator($routes)->generate('test'));

        $routes = $this->getRoutes('test', new Route('/', array(), array('_scheme' => 'https')));
        $this->assertEquals('/API.php/', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test'));
    }

    public function testSchemeRequirementForcesAbsoluteUrl()
    {
        $routes = $this->getRoutes('test', new Route('/', array(), array('_scheme' => 'https')));
        $this->assertEquals('https://localhost/API.php/', $this->getGenerator($routes)->generate('test'));

        $routes = $this->getRoutes('test', new Route('/', array(), array('_scheme' => 'http')));
        $this->assertEquals('http://localhost/API.php/', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test'));
    }
    ...
    public function testNoTrailingSlashForMultipleOptionalParameters()
    {
        ...
        $this->assertEquals('/API.php/category/foo', $this->getGenerator($routes)->generate('test', array('slug1' => 'foo')));
    }
    ...
    public function testWithAnIntegerAsADefaultValue()
    {
        ...
        $this->assertEquals('/API.php/foo', $this->getGenerator($routes)->generate('test', array('default' => 'foo')));
    }
    ...
    public function testUrlEncoding()
    {
        ...
        $this->assertSame('/API.php/@:%5B%5D/%28%29*%27%22%20+,;-._~%26%24%3C%3E|%7B%7D%25%5C%5E%60!%3Ffoo=bar%23id'
    ...
    public function testEncodingOfRelativePathSegments()
    {
        ...
        $this->assertSame('/API.php/dir/%2E%2E/dir/%2E%2E', $this->getGenerator($routes)->generate('test'));
        $routes = $this->getRoutes('test', new Route('/dir/./dir/.'));
        $this->assertSame('/API.php/dir/%2E/dir/%2E', $this->getGenerator($routes)->generate('test'));
        $routes = $this->getRoutes('test', new Route('/a./.a/a../..a/...'));
        $this->assertSame('/API.php/a./.a/a../..a/...', $this->getGenerator($routes)->generate('test'));
    }
